...
dev-release:
	...
	@tar -xzvf .dev_builds/release.tgz -C .dev_builds release.MF
	@bosh int .dev_builds/release.MF --path /version > .dev_builds/version
	@mv .dev_builds/release.tgz .dev_builds/jumpbox-utils-$$(cat .dev_builds/version).tgz

final-release:
	@bosh create-release --final --tarball=.final_builds/release.tgz
	@tar -xzvf .final_builds/release.tgz -C .final_builds release.MF
	@bosh int .final_builds/release.MF --path /version > .final_builds/version
	@mv .final_builds/release.tgz .final_builds/jumpbox-utils-$$(cat .final_builds/version).tgz
